...
class GeneralSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        //MAPA-MODES
        //FIFA
        ModeMapa::create(['mapa_id' => $manchestercityacademystadium_MapaId, 'mode_joc_id' => $partidoRapido]);
        ModeMapa::create(['mapa_id' => $philipsstadion_MapaId, 'mode_joc_id' => $partidoRapido]);
        ModeMapa::create(['mapa_id' => $elsadar_MapaId, 'mode_joc_id' => $partidoRapido]);
        ModeMapa::create(['mapa_id' => $estadiojosézorrilla_MapaId, 'mode_joc_id' => $partidoRapido]);
        ModeMapa::create(['mapa_id' => $labombonera_MapaId, 'mode_joc_id' => $partidoRapido]);
        ModeMapa::create(['mapa_id' => $allianzstadium_MapaId, 'mode_joc_id' => $partidoRapido]);

        //VALORANT
        ModeMapa::create(['mapa_id' => $abyss_MapaId, 'mode_joc_id' => $spikeRush]);
        ModeMapa::create(['mapa_id' => $abyss_MapaId, 'mode_joc_id' => $plantarDefusar]);
        ModeMapa::create(['mapa_id' => $abyss_MapaId, 'mode_joc_id' => $deathmatch]);
        ModeMapa::create(['mapa_id' => $abyss_MapaId, 'mode_joc_id' => $guerraDeLaNieve]);
        ModeMapa::create(['mapa_id' => $bind_MapaId, 'mode_joc_id' => $spikeRush]);
        ModeMapa::create(['mapa_id' => $bind_MapaId, 'mode_joc_id' => $plantarDefusar]);
        ModeMapa::create(['mapa_id' => $bind_MapaId, 'mode_joc_id' => $deathmatch]);
        ModeMapa::create(['mapa_id' => $bind_MapaId, 'mode_joc_id' => $guerraDeLaNieve]);
        ModeMapa::create(['mapa_id' => $fracture_MapaId, 'mode_joc_id' => $spikeRush]);
        ModeMapa::create(['mapa_id' => $fracture_MapaId, 'mode_joc_id' => $plantarDefusar]);
        ModeMapa::create(['mapa_id' => $fracture_MapaId, 'mode_joc_id' => $deathmatch]);
        ModeMapa::create(['mapa_id' => $fracture_MapaId, 'mode_joc_id' => $guerraDeLaNieve]);
        ModeMapa::create(['mapa_id' => $haven_MapaId, 'mode_joc_id' => $spikeRush]);
        ModeMapa::create(['mapa_id' => $haven_MapaId, 'mode_joc_id' => $plantarDefusar]);
        ModeMapa::create(['mapa_id' => $haven_MapaId, 'mode_joc_id' => $deathmatch]);
        ModeMapa::create(['mapa_id' => $haven_MapaId, 'mode_joc_id' => $guerraDeLaNieve]);
        ModeMapa::create(['mapa_id' => $lotus_MapaId, 'mode_joc_id' => $spikeRush]);
        ModeMapa::create(['mapa_id' => $lotus_MapaId, 'mode_joc_id' => $plantarDefusar]);
        ModeMapa::create(['mapa_id' => $lotus_MapaId, 'mode_joc_id' => $deathmatch]);
        ModeMapa::create(['mapa_id' => $lotus_MapaId, 'mode_joc_id' => $guerraDeLaNieve]);
        ModeMapa::create(['mapa_id' => $pearl_MapaId, 'mode_joc_id' => $spikeRush]);
        ModeMapa::create(['mapa_id' => $pearl_MapaId, 'mode_joc_id' => $plantarDefusar]);
        ModeMapa::create(['mapa_id' => $pearl_MapaId, 'mode_joc_id' => $deathmatch]);
        ModeMapa::create(['mapa_id' => $pearl_MapaId, 'mode_joc_id' => $guerraDeLaNieve]);
        ModeMapa::create(['mapa_id' => $split_MapaId, 'mode_joc_id' => $spikeRush]);
        ModeMapa::create(['mapa_id' => $split_MapaId, 'mode_joc_id' => $plantarDefusar]);
        ModeMapa::create(['mapa_id' => $split_MapaId, 'mode_joc_id' => $deathmatch]);
        ModeMapa::create(['mapa_id' => $split_MapaId, 'mode_joc_id' => $guerraDeLaNieve]);

        //BRAWL STARS SUPERVIVENCIA
        ModeMapa::create(['mapa_id' => $arroyocalavera_MapaId, 'mode_joc_id' => $supervicencia]);
        ModeMapa::create(['mapa_id' => $lagosacidos_MapaId, 'mode_joc_id' => $supervicencia]);
        ModeMapa::create(['mapa_id' => $cuevaprofunda_MapaId, 'mode_joc_id' => $supervicencia]);
        ModeMapa::create(['mapa_id' => $dobledilema_MapaId, 'mode_joc_id' => $supervicencia]);
        ModeMapa::create(['mapa_id' => $nucleoorbital_MapaId, 'mode_joc_id' => $supervicencia]);
        ModeMapa::create(['mapa_id' => $arboledadenenufares_MapaId, 'mode_joc_id' => $supervicencia]);

        //BRAWL STARS ATRAPAGEMAS
        ModeMapa::create(['mapa_id' => $minarocosa_MapaId, 'mode_joc_id' => $atrapagemas]);
        ModeMapa::create(['mapa_id' => $fuertedegemas_MapaId, 'mode_joc_id' => $atrapagemas]);
        ModeMapa::create(['mapa_id' => $cuevasubterranea_MapaId, 'mode_joc_id' => $atrapagemas]);
        ModeMapa::create(['mapa_id' => $brrrumbrrrum_MapaId, 'mode_joc_id' => $atrapagemas]);
        ModeMapa::create(['mapa_id' => $ultimaparada_MapaId, 'mode_joc_id' => $atrapagemas]);
        ModeMapa::create(['mapa_id' => $clarodelbosque_MapaId, 'mode_joc_id' => $atrapagemas]);

        //BRAWL STARS BALON BRAWL
        ModeMapa::create(['mapa_id' => $estadiobrawl_MapaId, 'mode_joc_id' => $balonBrawl]);
        ModeMapa::create(['mapa_id' => $camposfuritivos_MapaId, 'mode_joc_id' => $balonBrawl]);
        ModeMapa::create(['mapa_id' => $futbolsoleado_MapaId, 'mode_joc_id' => $balonBrawl]);
        ModeMapa::create(['mapa_id' => $tripledrible_MapaId, 'mode_joc_id' => $balonBrawl]);
        ModeMapa::create(['mapa_id' => $canchapeleona_MapaId, 'mode_joc_id' => $balonBrawl]);
        ModeMapa::create(['mapa_id' => $segundointento_MapaId, 'mode_joc_id' => $balonBrawl]);

        //BRAWL STARS ATRACO
        ModeMapa::create(['mapa_id' => $neumaticosmaniaticos_MapaId, 'mode_joc_id' => $atraco]);
        ModeMapa::create(['mapa_id' => $canonexplosivo_MapaId, 'mode_joc_id' => $atraco]);
        ModeMapa::create(['mapa_id' => $refugio_MapaId, 'mode_joc_id' => $atraco]);
        ModeMapa::create(['mapa_id' => $patatacalient_MapaId, 'mode_joc_id' => $atraco]);
        ModeMapa::create(['mapa_id' => $aguasturbulentas_MapaId, 'mode_joc_id' => $atraco]);
        ModeMapa::create(['mapa_id' => $instruccionessencillas_MapaId, 'mode_joc_id' => $atraco]);

        //BRAWL STARS CAZA ESTELAR
        ModeMapa::create(['mapa_id' => $tiroteoestelar_MapaId, 'mode_joc_id' => $cazaEstelar]);
        ModeMapa::create(['mapa_id' => $escondite_MapaId, 'mode_joc_id' => $cazaEstelar]);
        ModeMapa::create(['mapa_id' => $crimenorganizado_MapaId, 'mode_joc_id' => $cazaEstelar]);
        ModeMapa::create(['mapa_id' => $sequiasanguinaria_MapaId, 'mode_joc_id' => $cazaEstelar]);
        ModeMapa::create(['mapa_id' => $ningunaexcusa_MapaId, 'mode_joc_id' => $cazaEstelar]);
        ModeMapa::create(['mapa_id' => $impactoinminente_MapaId, 'mode_joc_id' => $cazaEstelar]);

        //BRAWL STARS ZONA RESTRINGIDA
        ModeMapa::create(['mapa_id' => $campoabierto_MapaId, 'mode_joc_id' => $zonaRestringida]);
        ModeMapa::create(['mapa_id' => $pisaardiente_MapaId, 'mode_joc_id' => $zonaRestringida]);
        ModeMapa::create(['mapa_id' => $duelodeescarabajos_MapaId, 'mode_joc_id' => $zonaRestringida]);
        ModeMapa::create(['mapa_id' => $zonaabierta_MapaId, 'mode_joc_id' => $zonaRestringida]);
        ModeMapa::create(['mapa_id' => $joyasbrillantes_MapaId, 'mode_joc_id' => $zonaRestringida]);
        ModeMapa::create(['mapa_id' => $pescacomoda_MapaId, 'mode_joc_id' => $zonaRestringida]);

        //BRAWL STARS NOQUEO
        ModeMapa::create(['mapa_id' => $rocadebelle_MapaId, 'mode_joc_id' => $noqueo]);
        ModeMapa::create(['mapa_id' => $hastaelfondo_MapaId, 'mode_joc_id' => $noqueo]);
        ModeMapa::create(['mapa_id' => $alainterperie_MapaId, 'mode_joc_id' => $noqueo]);
        ModeMapa::create(['mapa_id' => $terminomediosano_MapaId, 'mode_joc_id' => $noqueo]);
        ModeMapa::create(['mapa_id' => $nuevoshorizontes_MapaId, 'mode_joc_id' => $noqueo]);
        ModeMapa::create(['mapa_id' => $crucemusgoso_MapaId, 'mode_joc_id' => $noqueo]);

        //FORTNITE BATTLE ROYALE
        ModeMapa::create(['mapa_id' => $construccion_MapaId, 'mode_joc_id' => $battleRoyale]);

        //FORTNITE CERO CONSTRUCCIÓN
        ModeMapa::create(['mapa_id' => $ceroConstruccion_MapaId, 'mode_joc_id' => $ceroConstruccion]);

        //ROCKET LEAGUE 1V1 2V2 3V3 4V4
        ModeMapa::create(['mapa_id' => $championsfield_MapaId, 'mode_joc_id' => $rocket1]);
        ModeMapa::create(['mapa_id' => $championsfield_MapaId, 'mode_joc_id' => $rocket2]);
        ModeMapa::create(['mapa_id' => $championsfield_MapaId, 'mode_joc_id' => $rocket3]);
        ModeMapa::create(['mapa_id' => $championsfield_MapaId, 'mode_joc_id' => $rocket4]);

        ModeMapa::create(['mapa_id' => $neotokyo_MapaId, 'mode_joc_id' => $rocket1]);
        ModeMapa::create(['mapa_id' => $neotokyo_MapaId, 'mode_joc_id' => $rocket2]);
        ModeMapa::create(['mapa_id' => $neotokyo_MapaId, 'mode_joc_id' => $rocket3]);
        ModeMapa::create(['mapa_id' => $neotokyo_MapaId, 'mode_joc_id' => $rocket4]);

        ModeMapa::create(['mapa_id' => $deadeyecanyon_MapaId, 'mode_joc_id' => $rocket1]);
        ModeMapa::create(['mapa_id' => $deadeyecanyon_MapaId, 'mode_joc_id' => $rocket2]);
        ModeMapa::create(['mapa_id' => $deadeyecanyon_MapaId, 'mode_joc_id' => $rocket3]);
        ModeMapa::create(['mapa_id' => $deadeyecanyon_MapaId, 'mode_joc_id' => $rocket4]);

        ModeMapa::create(['mapa_id' => $saltyshores_MapaId, 'mode_joc_id' => $rocket1]);
        ModeMapa::create(['mapa_id' => $saltyshores_MapaId, 'mode_joc_id' => $rocket2]);
        ModeMapa::create(['mapa_id' => $saltyshores_MapaId, 'mode_joc_id' => $rocket3]);
        ModeMapa::create(['mapa_id' => $saltyshores_MapaId, 'mode_joc_id' => $rocket4]);

        ModeMapa::create(['mapa_id' => $farmstead_MapaId, 'mode_joc_id' => $rocket1]);
        ModeMapa::create(['mapa_id' => $farmstead_MapaId, 'mode_joc_id' => $rocket2]);
        ModeMapa::create(['mapa_id' => $farmstead_MapaId, 'mode_joc_id' => $rocket3]);
        ModeMapa::create(['mapa_id' => $farmstead_MapaId, 'mode_joc_id' => $rocket4]);

        ModeMapa::create(['mapa_id' => $starbasearc_MapaId, 'mode_joc_id' => $rocket1]);
        ModeMapa::create(['mapa_id' => $starbasearc_MapaId, 'mode_joc_id' => $rocket2]);
        ModeMapa::create(['mapa_id' => $starbasearc_MapaId, 'mode_joc_id' => $rocket3]);
        ModeMapa::create(['mapa_id' => $starbasearc_MapaId, 'mode_joc_id' => $rocket4]);

        //ROCKET LEAGUE HIELO
        ModeMapa::create(['mapa_id' => $beckwithpark_MapaId, 'mode_joc_id' => $hielo]);
        ModeMapa::create(['mapa_id' => $dfhstadium_MapaId, 'mode_joc_id' => $hielo]);
        ModeMapa::create(['mapa_id' => $mannfield_MapaId, 'mode_joc_id' => $hielo]);
        ModeMapa::create(['mapa_id' => $throwbackstadium_MapaId, 'mode_joc_id' => $hielo]);
        ModeMapa::create(['mapa_id' => $utopiacoliseum_MapaId, 'mode_joc_id' => $hielo]);

        //ROCKET LEAGUE HOOPS
        ModeMapa::create(['mapa_id' => $dunkhouse_MapaId, 'mode_joc_id' => $hoops]);
        ModeMapa::create(['mapa_id' => $theblock_MapaId, 'mode_joc_id' => $hoops]);

        //CLASH ROYALE 1VS1
        ModeMapa::create(['mapa_id' => $arena10_MapaId, 'mode_joc_id' => $clashRoyale1]);

        //CLASH ROYALE TOUCHDOWN
        ModeMapa::create(['mapa_id' => $touchdown_MapaId, 'mode_joc_id' => $touchdown]);

        //MARIOKART 8 DELUXE
        ModeMapa::create(['mapa_id' => $copachampiñón_MapaId, 'mode_joc_id' => $juegoEnLinea]);
        ModeMapa::create(['mapa_id' => $copaflor_MapaId, 'mode_joc_id' => $juegoEnLinea]);
        ModeMapa::create(['mapa_id' => $copaestrella_MapaId, 'mode_joc_id' => $juegoEnLinea]);
        ModeMapa::create(['mapa_id' => $copaespecial_MapaId, 'mode_joc_id' => $juegoEnLinea]);
        ModeMapa::create(['mapa_id' => $copacaparazón_MapaId, 'mode_joc_id' => $juegoEnLinea]);
        ModeMapa::create(['mapa_id' => $copaplátano_MapaId, 'mode_joc_id' => $juegoEnLinea]);
        ModeMapa::create(['mapa_id' => $copahoja_MapaId, 'mode_joc_id' => $juegoEnLinea]);
        ModeMapa::create(['mapa_id' => $copacentella_MapaId, 'mode_joc_id' => $juegoEnLinea]);
        ModeMapa::create(['mapa_id' => $copahuevo_MapaId, 'mode_joc_id' => $juegoEnLinea]);
        ModeMapa::create(['mapa_id' => $copacrossing_MapaId, 'mode_joc_id' => $juegoEnLinea]);
        ModeMapa::create(['mapa_id' => $copatrifuerza_MapaId, 'mode_joc_id' => $juegoEnLinea]);
        ModeMapa::create(['mapa_id' => $copacampana_MapaId, 'mode_joc_id' => $juegoEnLinea]);

        //LOL
        ModeMapa::create(['mapa_id' => $mapalol_MapaId, 'mode_joc_id' => $grietaDelInvocador]);
        ModeMapa::create(['mapa_id' => $mapalol_MapaId, 'mode_joc_id' => $aram]);
        ModeMapa::create(['mapa_id' => $mapalol_MapaId, 'mode_joc_id' => $modoRotativo]);
    ...
    $torneigIndividual = DB::table('torneigs')->insertGetIdTorneig::create([
