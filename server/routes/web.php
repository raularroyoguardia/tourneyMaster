...
Route::match(['get', 'post'], '/api/equip/new', [EquipController::class, 'new'])->name('equip_new');
...
Route::match(['get', 'post'], '/api/user/new', [UserController::class, 'new'])->name('user_new');
...
Route::match(['get', 'post'], '/api/joc/new', [JocController::class, 'new'])->name('joc_new');
...
Route::match(['get', 'post'], '/api/modejoc/new', [ModeDeJocController::class, 'new'])->name('modejoc_new');
...
Route::match(['get', 'post'], '/api/torneig/new', [TorneigController::class, 'new'])->name('torneig_new');
...
Route::match(['get', 'post'], '/api/partida/new', [PartidaController::class, 'new'])->name('partida_new');
...
Route::match(['get', 'post'], '/api/premi/new', [PremiController::class, 'new'])->name('premi_new');
